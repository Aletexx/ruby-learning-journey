...
class Ball
  ...
  def say_greeting
    greeting = "\t\t  Welcome to the Virtual Crazy 8-Ball game!" +
      "\n\n \t\t\t\tRules:
       \n1. Accept playing with y
        \n2. Ask any question you want
          \n3.Press enter after the answer to keep playing " +
    "\n\n\n\n\n\n\n\n\n\n\n\n\nPress Enter to " +
               "continue. \n\n: "
    print greeting
  end
  ...
  def say_goodbye
    ...
    author_info = "Author: Alessandro Bastos
                    \nSchool: https://www.melbournepolytechnic.edu.au/students/"
    puts goodbye
    puts author_info
...
if answer == "n"  #See if the player elected not to play
  ...
  until gameOver == "Yes"
    ...
    # Console_Screen.pause  #Pause the game
    Console_Screen.pause  #Pause the game # maybe wrong placr
